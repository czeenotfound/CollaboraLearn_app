                ...
                <div class="course-box">
                    ...
                    <div class="main-header">
                        ...
                        <div class="form__group">
                            ...
                            <?php endif ?>
                            <a href="<?= ROOT_URL ?>admin/delete-user-method.php?id=<?= $user['id'] ?>" class="btn btn-delete">Delete</a><br/>
                            <a href="<?= ROOT_URL ?>admin/manage_users.php" class="btn btn-dark">Cancel</a>    
                        </div>
                    </div>
                </div>
            </section>
